<?php
    ...
    $sql = "SELECT * FROM livros where disponivel = 0 order by nome_livro";
        ...
        <tbody>
            <?php
                while($user_data = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$user_data['ultimo_locador']."</td>";
                    echo "<td>
                    <a class='btn btn-sm btn btn-success' href='devolucao.php?id_livro=$user_data[id_livro]'>
