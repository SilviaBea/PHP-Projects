    ...
    if($id > 0){
        ...
        if($result->num_rows > 0){
            while($user_data = mysqli_fetch_assoc($result)){
                ...
                $data_nasci = $user_data['data_nasci'];
...
<body>
<a href="tela-livros-usuario.php">Voltar</a>
    <div class="box">
        <form action="saveEdit.php" method="POST">
            <fieldset>
                ...
                <input type="date" name="data_nasci" id="data_nasci" class="dataNasci" value="<?php echo $data_nasci?>" required>
                <br><br><br>
                <div class="inputBox">
                ...
                <div>
                    <p>Admin:</p>
                    <input type="radio" id="sim" name="admin" value="<?php echo($admin == '1') ? 'checked' : '' ?>" required>
                    <label for="sim">Sim</label>
                    <br>
                    <input type="radio" id="não" name="admin" value="<?php echo($admin == '0') ? 'checked' : '' ?>" required>
